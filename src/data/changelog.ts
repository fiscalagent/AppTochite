...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-05-18',
    changes: [
      'HistoryFeed сбрасывает страницу без лишнего эффекта',
      'атомарность БД-операций — транзакции при удалении клиента и updatedAt у аватара',
      'блюр модалок устойчив к наложению — переход на токены вместо глобального счётчика',
      'список клиентов открывается быстрее — один запрос вместо N+1',
    ],
  },
  {
    version: '1.55.1',
    date: '2026-05-18',
    changes: [
      'тип handleSave стал несовместим с onClick — обернул в стрелку',
      'голосовая диктовка — диспетчер команд с поддержкой стоп и повтори',
      'голосовая диктовка — кнопка-тумблер и индикатор «слышу» в шапке формы заточки',
      'голосовая диктовка — команды Заточки и добавление камня в список',
      'голосовая диктовка — команды Приёмки и список кандидатов для fuzzy-выбора',
      'голосовая диктовка — коррекции: очистить поле и удалить последний камень',
      'голосовая диктовка — навигация, сохранение и подтверждение отмены',
      'голосовая диктовка — хук непрерывного слушания с авто-перезапуском',
      'голосовая диктовка — устранены stale closure в колбэках и конфликт двух SR-сессий',
    ],
  },
  {
    version: '1.55.0',
  ...
  },
  {
    ...
    date: '2026-05-17',
    changes: [
      'микрофон не закрывается между поиском и довыбором — слушает 1000 мс подряд',
      'автоматический довыбор голосом — после списка микрофон сам слушает уточнение',
  ...
  },
  {
    ...
    date: '2026-05-17',
    changes: [
      'голосовой ввод — убрать авто-перезапуск, список совпадений всегда тапается',
      'голосовой ввод клиента и HRC, щадящий матчинг для русского произношения и фолбэк на произнесённый текст',
  ...
  },
  {
    ...
    date: '2026-05-17',
    changes: [
      'двухфазовый голосовой ввод — дропдаун и только справочник',
      'двухфазовый голосовой ввод для сталей, ножей и камней',
      'нечёткое распознавание камней по голосу — транслитерация и bigram-сходство',
      'нечёткое распознавание ножа и стали по голосу — транслитерация и bigram-сходство',
    ],
  },
  {
    version: '1.49.0',
