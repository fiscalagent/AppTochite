...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-06-23',
    changes: [
      'восстановление из облака — снимки в облаке стали справочным списком, восстановление через «Восстановить из файла»; добавлено подтверждение для «Заменить всё»',
      'восстановление и объединение бэкапа из облака через CORS-прокси',
    ],
  },
  {
    version: '1.106.0',
