...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-06-21',
    changes: [
      'ключ doneTotal в английском словаре — сборка падала на tsc -b',
      'счётчик заточенных ножей в шапке экрана «История»',
      'автобэкап не перезаписывает файл пустой базой данных',
      'игра «Расставь камни» — тренажёр зернистости в справочнике',
      'ссылка «Сайт приложения» в экране «О программе»',
      'merge бэкапа другого устройства без перемешивания клиентов — записи сопоставляются по guid',
      'облачные снапшоты по устройствам — телефон и планшет не перетирают бэкапы друг друга',
      'дата приёмки ночью больше не сдвигается на вчерашний день',
      'открытие удалённой записи показывает «не найдено» вместо пустого экрана',
      'сбой сети больше не отменяет облачный авто-бэкап на весь день',
      'дневной гейт и сигнатура данных для авто-бэкапа в облако',
    ],
  },
  {
    version: '1.98.0',
