...
const STONES: Omit<Stone, 'id'>[] = [
  // ОА (оксид алюминия)
  { brand: 'King KW-65',        ...fromJis(1000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'King KW-65',        ...fromJis(6000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Naniwa Chosera',    ...fromJis(400),   type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Naniwa Chosera',    ...fromJis(800),   type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Naniwa Chosera',    ...fromJis(1000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Naniwa Chosera',    ...fromJis(2000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Naniwa Chosera',    ...fromJis(3000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Naniwa Chosera',    ...fromJis(5000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Suehiro Cerax',     ...fromJis(1000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Suehiro Cerax',     ...fromJis(3000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Shapton Glass',     ...fromJis(500),   type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Shapton Glass',     ...fromJis(1000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Shapton Glass',     ...fromJis(2000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Shapton Glass',     ...fromJis(4000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Shapton Glass',     ...fromJis(8000),  type: 'ao',      category: 'ao',      isCustom: false },
  { brand: 'Shapton Glass',     ...fromJis(16000), type: 'ao',      category: 'ao',      isCustom: false },
  // Алмазные (гальваника)
  { brand: 'DMT Extra Coarse',    ...fromFepa(220),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT Coarse',          ...fromFepa(325),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT Fine',            ...fromFepa(600),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT Extra Fine',      ...fromFepa(1200), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'Атома Extra Coarse',  ...fromFepa(140),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'Атома Coarse',        ...fromFepa(360),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'Атома Fine',          ...fromFepa(600),  type: 'galvanic', category: 'galvanic', isCustom: false },
  // Природный камень
  { brand: 'Arkansas Soft',       ...fromFepa(400),  type: 'natural',  category: 'natural',  isCustom: false },
  { brand: 'Arkansas Hard',       ...fromFepa(800),  type: 'natural',  category: 'natural',  isCustom: false },
  { brand: 'Arkansas Black',      ...fromFepa(1200), type: 'natural',  category: 'natural',  isCustom: false },
  { brand: 'Norton India Fine',   ...fromJis(600),  type: 'ao',       category: 'ao',       isCustom: false },
  { brand: 'Norton India Medium', ...fromJis(300),  type: 'ao',       category: 'ao',       isCustom: false },
];
...
const STONES_V2: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'Naniwa Super Stone',  ...fromJis(220),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(400),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(1000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(2000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(3000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(5000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(8000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(10000), type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Naniwa Super Stone',  ...fromJis(12000), type: 'ao',    category: 'ao',    isCustom: false },
  // Shapton Kuromaku Pro (11 гритов)
  { brand: 'Shapton Kuromaku',    ...fromJis(120),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(320),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(1000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(2000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(5000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(8000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(12000), type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(16000), type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Shapton Kuromaku',    ...fromJis(20000), type: 'ao',    category: 'ao',    isCustom: false },
  // Suehiro Cerax (9 гритов)
  { brand: 'Suehiro Cerax',       ...fromJis(320),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(400),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(600),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(800),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(3000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(5000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(6000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(8000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Suehiro Cerax',       ...fromJis(10000), type: 'ao',    category: 'ao',    isCustom: false },
  // GRINDERMAN ОА (российский, 6 гритов)
  { brand: 'GRINDERMAN ОА',       ...fromJis(120),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'GRINDERMAN ОА',       ...fromJis(240),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'GRINDERMAN ОА',       ...fromJis(400),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'GRINDERMAN ОА',       ...fromJis(600),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'GRINDERMAN ОА',       ...fromJis(1000),  type: 'ao',    category: 'ao',    isCustom: false },
  // GRINDERMAN КК (зелёный карбид кремния, 5 гритов)
  { brand: 'GRINDERMAN КК',       ...fromFepa(120),   type: 'kk',    category: 'kk',    isCustom: false },
  { brand: 'GRINDERMAN КК',       ...fromFepa(240),   type: 'kk',    category: 'kk',    isCustom: false },
  { brand: 'GRINDERMAN КК',       ...fromFepa(400),   type: 'kk',    category: 'kk',    isCustom: false },
  { brand: 'GRINDERMAN КК',       ...fromFepa(600),   type: 'kk',    category: 'kk',    isCustom: false },
  { brand: 'GRINDERMAN КК',       ...fromFepa(1000),  type: 'kk',    category: 'kk',    isCustom: false },
  // GRINDERMAN Эльбор (3 гритов)
  { brand: 'GRINDERMAN Эльбор',   ...fromJis(400),   type: 'elbor', category: 'elbor', isCustom: false },
  { brand: 'GRINDERMAN Эльбор',   ...fromJis(600),   type: 'elbor', category: 'elbor', isCustom: false },
  { brand: 'GRINDERMAN Эльбор',   ...fromJis(1000),  type: 'elbor', category: 'elbor', isCustom: false },
  // DMT (дополнительные модели, 6 гритов)
  { brand: 'DMT DuoSharp',        ...fromFepa(325),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT DuoSharp',        ...fromFepa(600),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT DuoSharp',        ...fromFepa(1000),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT Ceramic',         ...fromFepa(220),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT Ceramic',         ...fromFepa(325),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'DMT Ceramic',         ...fromFepa(600),   type: 'galvanic', category: 'galvanic', isCustom: false },
  // King Pro (7 моделей)
  { brand: 'King Pro 300',        ...fromJis(300),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'King Pro 1200',       ...fromJis(1200),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'King Deluxe 1000',    ...fromJis(1000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'King Deluxe 2000',    ...fromJis(2000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'King Deluxe 4000',    ...fromJis(4000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'King Deluxe 6000',    ...fromJis(6000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'King Deluxe 8000',    ...fromJis(8000),  type: 'ao',    category: 'ao',    isCustom: false },
  // Imanishi Bester (4 гритов)
  { brand: 'Imanishi Bester',     ...fromJis(700),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Imanishi Bester',     ...fromJis(1200),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Imanishi Bester',     ...fromJis(2400),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Imanishi Bester',     ...fromJis(4000),  type: 'ao',    category: 'ao',    isCustom: false },
  // Boride (5 гритов)
  { brand: 'Boride Superfine',    ...fromJis(400),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Boride Superfine',    ...fromJis(600),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Boride Superfine',    ...fromJis(800),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Boride Superfine',    ...fromJis(1000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Boride Superfine',    ...fromJis(1200),  type: 'ao',    category: 'ao',    isCustom: false },
  // Norton India (дополнительно, 2 гритов)
  { brand: 'Norton India',        ...fromJis(1000),  type: 'ao',    category: 'ao',    isCustom: false },
  { brand: 'Norton India',        ...fromJis(1200),  type: 'ao',    category: 'ao',    isCustom: false },
  // Природные камни
  { brand: 'Washita Natural',     ...fromFepa(800),   type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Belgian Coticule',    ...fromFepa(8000),  type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Japanese Hon Suita',  ...fromFepa(5000),  type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Japanese Narutaki',   ...fromFepa(8000),  type: 'natural', category: 'natural', isCustom: false },
  // Синтетические советские камни
  { brand: 'БП-2 (советский)',    ...fromJis(800),   type: 'ao',    category: 'ao',    isCustom: false },
  { brand: '63С оселок',          ...fromFepa(600),   type: 'kk',    category: 'kk',    isCustom: false },
];
...
const STONES_V3: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'Gesshin 400',       ...fromJis(400),   type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Gesshin 2000',      ...fromJis(2000),  type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Gesshin 4000',      ...fromJis(4000),  type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Gesshin 6000',      ...fromJis(6000),  type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Gesshin 10000',     ...fromJis(10000), type: 'ao', category: 'ao', isCustom: false },
  // Dan's Whetstones (американский)
  { brand: "Dan's 120",         ...fromJis(120),   type: 'ao', category: 'ao', isCustom: false },
  { brand: "Dan's 220",         ...fromJis(220),   type: 'ao', category: 'ao', isCustom: false },
  { brand: "Dan's 300",         ...fromJis(300),   type: 'ao', category: 'ao', isCustom: false },
  { brand: "Dan's 400",         ...fromJis(400),   type: 'ao', category: 'ao', isCustom: false },
  { brand: "Dan's 600",         ...fromJis(600),   type: 'ao', category: 'ao', isCustom: false },
  { brand: "Dan's 800",         ...fromJis(800),   type: 'ao', category: 'ao', isCustom: false },
  // Eze-Lap Diamond (алмазные японские)
  { brand: 'Eze-Lap Diamond 120', ...fromJis(120), type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'Eze-Lap Diamond 220', ...fromJis(220), type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'Eze-Lap Diamond 400', ...fromJis(400), type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'Eze-Lap Diamond 600', ...fromJis(600), type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'Eze-Lap Diamond 1000', ...fromJis(1000), type: 'diamond', category: 'diamond', isCustom: false },
  // Венев эльбор (российский)
  { brand: 'Веневский Эльбор F120', ...fromJis(120), type: 'elbor', category: 'elbor', isCustom: false },
  { brand: 'Веневский Эльбор F240', ...fromJis(240), type: 'elbor', category: 'elbor', isCustom: false },
  { brand: 'Веневский Эльбор F400', ...fromJis(400), type: 'elbor', category: 'elbor', isCustom: false },
  // Lapping film (тонкие абразивные)
  { brand: '3M Trizact 220', ...fromFepa(220), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: '3M Trizact 320', ...fromFepa(320), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: '3M Trizact 400', ...fromFepa(400), type: 'galvanic', category: 'galvanic', isCustom: false },
  // Практические притиры (stropping compounds)
  { brand: 'Чугунный притир', ...fromJis(120), type: 'pritir', category: 'pritir', isCustom: false },
  { brand: 'Медный притир', ...fromJis(240), type: 'pritir', category: 'pritir', isCustom: false },
];
...
function genStones(brand: string, grits: number[], type: 'ao'|'galvanic'|'elbor'|'natural'|'diamond'='ao'): Omit<Stone,'id'>[] {
  const fn = (type === 'galvanic') ? fromFepa : fromJis
  return grits.map(g => ({brand, ...fn(g), type, category: type, isCustom: false}))
}
...
const STONES_V4: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'Japanese Suita', ...fromFepa(4000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Japanese Ozuku', ...fromFepa(6000), type: 'natural', category: 'natural', isCustom: false },
];
...
const STONES_V8: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'Dutch Belgian', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Belgian Buhrstone', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Whetstone Natural Edge', ...fromFepa(6000), type: 'natural', category: 'natural', isCustom: false },
];
...
const STONES_V7: Omit<Stone, 'id'>[] = [
  ...
  // Естественные
  { brand: 'Japanese Jnat Awado', ...fromFepa(4000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Japanese Jnat Awado', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Japanese Shoubudani', ...fromFepa(6000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Turkish Coticule', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Charnley Forest', ...fromFepa(5000), type: 'natural', category: 'natural', isCustom: false },
  // Старые советские
  { brand: 'Салтовский оселок', ...fromFepa(600), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Салтовский оселок', ...fromFepa(800), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Тульский оселок', ...fromJis(500), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Тульский оселок', ...fromJis(800), type: 'ao', category: 'ao', isCustom: false },
  // Синтетические разные
  { brand: 'Crystolon', ...fromFepa(400), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Crystolon', ...fromFepa(600), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Crystolon', ...fromFepa(1000), type: 'kk', category: 'kk', isCustom: false },
];
...
const STONES_V6: Omit<Stone, 'id'>[] = [
  ...
  // Натуральные камни
  { brand: 'Barber Hone', ...fromFepa(5000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Barber Hone', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Man\'s Stone', ...fromFepa(6000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Belge', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Belge', ...fromFepa(12000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Novaculite', ...fromFepa(6000), type: 'natural', category: 'natural', isCustom: false },
  // Советские оселки
  { brand: 'ВВ-1 оселок', ...fromFepa(500), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'ВВ-1 оселок', ...fromFepa(1000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'УУЛ оселок', ...fromJis(400), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'УУЛ оселок', ...fromJis(600), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'УУЛ оселок', ...fromJis(800), type: 'ao', category: 'ao', isCustom: false },
];
...
const STONES_V5: Omit<Stone, 'id'>[] = [
  ...
  // Привет льные камни
  { brand: 'Stropping Leather', ...fromFepa(12000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Arkansas Translucent', ...fromFepa(600), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Arkansas Washita', ...fromFepa(1200), type: 'natural', category: 'natural', isCustom: false },
  // Российские камни
  ...genStones('Венев Кварц', [200, 400, 600], 'ao'),
  ...genStones('Венев Карбид', [120, 240, 400], 'ao'),
  { brand: 'БМЗ-3 советский', ...fromJis(400), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'БМЗ-3 советский', ...fromJis(800), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'АБЖ 1М оселок', ...fromFepa(600), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'АБЖ 1М оселок', ...fromFepa(400), type: 'kk', category: 'kk', isCustom: false },
  // Японские натуральные
  { brand: 'Aoto', ...fromFepa(3000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Aoto', ...fromFepa(5000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Tomoye', ...fromFepa(4000), type: 'natural', category: 'natural', isCustom: false },
...
const STONES_V9: Omit<Stone, 'id'>[] = [
  ...
  // Природные варианты
  { brand: 'Coticule Belgian', ...fromFepa(12000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Charnley Forest Rubber', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Surgical Black Arkansas', ...fromFepa(10000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Escher German Stone', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
];
...
const STONES_V10: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'Imanishi Nakayama Suita', ...fromFepa(10000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Imanishi Tomae Awasedo', ...fromFepa(8000), type: 'natural', category: 'natural', isCustom: false },
  { brand: 'Japanese Ozuku', ...fromFepa(12000), type: 'natural', category: 'natural', isCustom: false },
];
...
const STONES_V11: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'TSPROF Alpha', ...fromMk('160/125'), type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('125/100'), type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('100/80'),  type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('80/63'),   type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('60/40'),   type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('40/28'),   type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('28/20'),   type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('20/14'),   type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('14/10'),   type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('10/7'),    type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('7/5'),     type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('5/3'),     type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('3/2'),     type: 'diamond', category: 'diamond', isCustom: false },
  { brand: 'TSPROF Alpha', ...fromMk('2/1'),     type: 'diamond', category: 'diamond', isCustom: false },
  // ── ВеАл — алмазные бруски (гальваника, МК) ──────────────────────────────────
  { brand: 'ВеАл', ...fromMk('200/160'), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('160/125'), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('125/100'), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('100/80'),  type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('80/63'),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('50/40'),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('40/28'),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('28/20'),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('20/14'),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('14/10'),   type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('10/7'),    type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('7/5'),     type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('5/3'),     type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'ВеАл', ...fromMk('3/2'),     type: 'galvanic', category: 'galvanic', isCustom: false },
  // ── TSPROF F-пластины — алмазные плёнки (гальваника, FEPA) ───────────────────
  { brand: 'TSPROF F-plate', ...fromFepa(150), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'TSPROF F-plate', ...fromFepa(220), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'TSPROF F-plate', ...fromFepa(400), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'TSPROF F-plate', ...fromFepa(600), type: 'galvanic', category: 'galvanic', isCustom: false },
  { brand: 'TSPROF F-plate', ...fromFepa(1000), type: 'galvanic', category: 'galvanic', isCustom: false },
  // ── Boride T2 — оксид алюминия, керамическая связка (FEPA) ───────────────────
  { brand: 'Boride T2', ...fromFepa(150), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Boride T2', ...fromFepa(220), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Boride T2', ...fromFepa(400), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Boride T2', ...fromFepa(600), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Boride T2', ...fromFepa(1000), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'Boride T2', ...fromFepa(1200), type: 'ao', category: 'ao', isCustom: false },
  // ── Boride CS-HD — карбид кремния, керамическая связка (FEPA) ────────────────
  { brand: 'Boride CS-HD', ...fromFepa(120), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride CS-HD', ...fromFepa(220), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride CS-HD', ...fromFepa(400), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride CS-HD', ...fromFepa(600), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride CS-HD', ...fromFepa(1000), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride CS-HD', ...fromFepa(1200), type: 'kk', category: 'kk', isCustom: false },
  // ── Boride PC — карбид кремния, полиуретановая связка (FEPA) ─────────────────
  { brand: 'Boride PC', ...fromFepa(150), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride PC', ...fromFepa(320), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride PC', ...fromFepa(600), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'Boride PC', ...fromFepa(900), type: 'kk', category: 'kk', isCustom: false },
  // ── TSPROF Delta OA — оксид алюминия (FEPA) ──────────────────────────────────
  { brand: 'TSPROF Delta OA', ...fromFepa(800), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'TSPROF Delta OA', ...fromFepa(1200), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'TSPROF Delta OA', ...fromFepa(1500), type: 'ao', category: 'ao', isCustom: false },
  // ── TSPROF Delta CS — карбид кремния (FEPA) ──────────────────────────────────
  { brand: 'TSPROF Delta CS', ...fromFepa(120), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Delta CS', ...fromFepa(220), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Delta CS', ...fromFepa(400), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Delta CS', ...fromFepa(600), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Delta CS', ...fromFepa(800), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Delta CS', ...fromFepa(1000), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Delta CS', ...fromFepa(1200), type: 'kk', category: 'kk', isCustom: false },
  // ── TSPROF Профиль A — оксид алюминия (FEPA) ─────────────────────────────────
  { brand: 'TSPROF Профиль A', ...fromFepa(120), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'TSPROF Профиль A', ...fromFepa(220), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'TSPROF Профиль A', ...fromFepa(400), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'TSPROF Профиль A', ...fromFepa(600), type: 'ao', category: 'ao', isCustom: false },
  { brand: 'TSPROF Профиль A', ...fromFepa(1000), type: 'ao', category: 'ao', isCustom: false },
  // ── TSPROF Профиль CS — карбид кремния (FEPA) ────────────────────────────────
  { brand: 'TSPROF Профиль CS', ...fromFepa(120), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Профиль CS', ...fromFepa(220), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Профиль CS', ...fromFepa(400), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Профиль CS', ...fromFepa(600), type: 'kk', category: 'kk', isCustom: false },
  { brand: 'TSPROF Профиль CS', ...fromFepa(1000), type: 'kk', category: 'kk', isCustom: false },
...
const STONES_CATALOG_RU: Omit<Stone, 'id'>[] = [
  ...
  { brand: 'GRINDERMAN OA', ...fromFepa(400), type: 'ao', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN OA', ...fromFepa(600), type: 'ao', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN OA', ...fromFepa(800), type: 'ao', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN OA', ...fromFepa(1000), type: 'ao', coolant: 'water', isCustom: false },
  // ── GRINDERMAN KK — КК, вода, FEPA ───────────────────────────────────────
  { brand: 'GRINDERMAN KK', ...fromFepa(120), type: 'kk', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN KK', ...fromFepa(220), type: 'kk', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN KK', ...fromFepa(400), type: 'kk', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN KK', ...fromFepa(600), type: 'kk', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN KK', ...fromFepa(800), type: 'kk', coolant: 'water', isCustom: false },
  { brand: 'GRINDERMAN KK', ...fromFepa(1000), type: 'kk', coolant: 'water', isCustom: false },
  // ── GRINDERMAN Oil OA — ОА, масло, JIS ───────────────────────────────────
  { brand: 'GRINDERMAN Oil OA', ...fromJis(120), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(240), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(600), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(1200), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(2000), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(2500), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(4000), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil OA', ...fromJis(6000), type: 'ao', coolant: 'oil', isCustom: false },
  // ── GRINDERMAN Oil KK — КК, масло, JIS ───────────────────────────────────
  { brand: 'GRINDERMAN Oil KK', ...fromJis(120), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(240), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(600), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(1200), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(2000), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(2500), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(4000), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(6000), type: 'kk', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN Oil KK', ...fromJis(10000), type: 'kk', coolant: 'oil', isCustom: false },
  // ── GRINDERMAN CLR Oil OA — ОА, масло, JIS ───────────────────────────────
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(120), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(240), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(600), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(1200), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(2000), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(2500), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(4000), type: 'ao', coolant: 'oil', isCustom: false },
  { brand: 'GRINDERMAN CLR Oil OA', ...fromJis(6000), type: 'ao', coolant: 'oil', isCustom: false },
  // ── IndiaKeller KK — КК, вода+масло, FEPA ────────────────────────────────
  { brand: 'IndiaKeller KK', ...fromFepa(180), type: 'kk', coolant: 'both', isCustom: false },
  { brand: 'IndiaKeller KK', ...fromFepa(320), type: 'kk', coolant: 'both', isCustom: false },
  { brand: 'IndiaKeller KK', ...fromFepa(400), type: 'kk', coolant: 'both', isCustom: false },
  { brand: 'IndiaKeller KK', ...fromFepa(600), type: 'kk', coolant: 'both', isCustom: false },
  { brand: 'IndiaKeller KK', ...fromFepa(800), type: 'kk', coolant: 'both', isCustom: false },
  { brand: 'IndiaKeller KK', ...fromFepa(1000), type: 'kk', coolant: 'both', isCustom: false },
  // ── AK (АнигиляторКастрюль) OA — ОА, вода+масло, FEPA ───────────────────
  { brand: 'AK (АнигиляторКастрюль) OA', ...fromFepa(180), type: 'ao', coolant: 'both', isCustom: false },
  { brand: 'AK (АнигиляторКастрюль) OA', ...fromFepa(320), type: 'ao', coolant: 'both', isCustom: false },
  { brand: 'AK (АнигиляторКастрюль) OA', ...fromFepa(400), type: 'ao', coolant: 'both', isCustom: false },
  { brand: 'AK (АнигиляторКастрюль) OA', ...fromFepa(600), type: 'ao', coolant: 'both', isCustom: false },
  { brand: 'AK (АнигиляторКастрюль) OA', ...fromFepa(800), type: 'ao', coolant: 'both', isCustom: false },
  { brand: 'AK (АнигиляторКастрюль) OA', ...fromFepa(1000), type: 'ao', coolant: 'both', isCustom: false },
  ...
  { brand: 'Венёв Двусторонний B2-01 Алмаз 25%', ...fromMk('200/160'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний B2-01 Алмаз 25%', ...fromMk('160/125'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний B2-01 Алмаз 25%', ...fromMk('100/80'),  type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний B2-01 Алмаз 25%', ...fromMk('50/40'),   type: 'diamond', coolant: 'water', isCustom: false },
  // ── Венёв OSB Алмаз 25% — алмаз, вода, мк ───────────────────────────────
  { brand: 'Венёв Двусторонний OSB Алмаз 25%', ...fromMk('20/14'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний OSB Алмаз 25%', ...fromMk('14/10'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний OSB Алмаз 25%', ...fromMk('7/5'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний OSB Алмаз 25%', ...fromMk('5/3'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний OSB Алмаз 25%', ...fromMk('3/2'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв Двусторонний OSB Алмаз 25%', ...fromMk('1/0'),   type: 'diamond', coolant: 'water', isCustom: false },
  // ── Венёв MS-1 Алмаз 100% — алмаз, вода, мк ─────────────────────────────
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('250/200'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('200/160'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('160/125'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('125/100'), type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('100/80'),  type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('80/63'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('63/50'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('50/40'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('40/28'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('28/20'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('20/14'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('14/10'),   type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('10/7'),    type: 'diamond', coolant: 'water', isCustom: false },
  { brand: 'Венёв MS-1 Алмаз 100%', ...fromMk('7/5'),     type: 'diamond', coolant: 'water', isCustom: false },
  // ── Венёв MB-1 Алмаз 100% — алмаз, вода, мк ─────────────────────────────
  { brand: 'Венёв MB-1 Алмаз 100%', ...fromMk('5/3'), type: 'diamond', coolant: 'water', isCustom: false },
